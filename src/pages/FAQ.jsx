...
export default function Faq() {
  const faqs = useMemo(
    () => [
      ...
      {
  q: "お問い合わせと予約の違いは何ですか？",
  a: "「予約」はカウンセリングを受ける日時を確定する手続きです（空き枠の選択→予約確定）。「お問い合わせ」は、予約前の不明点の確認や、サービス内容・料金・受け方などの相談、予約に関するトラブル（日時変更の相談など）をするための連絡フォームです。すぐに相談を始めたい場合は「予約」、まず確認したいことがある場合は「お問い合わせ」をご利用ください。",
}
